...
app.controller('myController',['$scope','socket','$http','$mdDialog','$compile','$location','$state','$localStorage', '$sessionStorage',function($scope,socket,$http,$mdDialog,$compile,$location,$state,$localStorage, $sessionStorage){
    ...
    socket.on('username', function(data) {
        $scope.user = data;
        console.log("Get username : "+$scope.user);
    });
    ...
    $scope.confirm=function(){
        var data = {
            "friend_username":$scope.friend,
            "my_username":$scope.user
        };
    ...
    $scope.showConfirm = function(data) {
        ...
        .textContent(data.my_username+' wants to connect.Do you want to Connect?')
        .ariaLabel('Lucky day')
        .ok('Ok')
        .cancel('No');
